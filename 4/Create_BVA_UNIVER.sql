use master;
create database BVA_UNIVER
on primary
(name='BVA_UNIVER_mdf', filename='E:\study\lab4sem\SQL\4\BVA_UNIVER_mdf.mdf',size=5Mb, maxsize=10Mb,filegrowth=1Mb),
(name='BVA_UNIVER_ndf', filename='E:\study\lab4sem\SQL\4\BVA_UNIVER_ndf.ndf',size=5Mb, maxsize=10Mb,filegrowth=10%),
filegroup G1
(name='BVA_UNIVER11_ndf', filename='E:\study\lab4sem\SQL\4\BVA_UNIVER11_ndf.ndf',size=5Mb, maxsize=15Mb,filegrowth=1Mb),
(name='BVA_UNIVER12_ndf', filename='E:\study\lab4sem\SQL\4\BVA_UNIVER12_ndf.ndf',size=2Mb, maxsize=5Mb,filegrowth=1Mb),
filegroup G2
(name='BVA_UNIVER21_ndf', filename='E:\study\lab4sem\SQL\4\BVA_UNIVER21_ndf.ndf',size=5Mb, maxsize=10Mb,filegrowth=1Mb),
(name='BVA_UNIVER22_ndf', filename='E:\study\lab4sem\SQL\4\BVA_UNIVER22_ndf.ndf',size=2Mb, maxsize=5Mb,filegrowth=1Mb)
log on
(name='BVA_UNIVER_ldf', filename='E:\study\lab4sem\SQL\4\BVA_UNIVER_ldf.ldf',size=5Mb, maxsize=unlimited,filegrowth=1Mb)
