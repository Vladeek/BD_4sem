...
insert into STUDENT(IDGROUP, NAME, BDAY, INFO)
	values(22, 'Шихов М.В.', '10.07.1998',
	'<студент>
		<паспорт серия="АВ" номер="1111111" дата="31.07.2020" />
		<телефон>0</телефон>
		<адрес>
...
select * from STUDENT where NAME = 'Шихов М.В.';
update STUDENT set INFO = '<студент>
					           <паспорт серия="AB" номер="1111111" дата="31.07.2020" />
							   <телефон>0</телефон>
							   <адрес>
								  <страна>Беларусь</страна>
								  <город>Брест</город>
...
select Name, INFO from STUDENT where NAME='Шихов М.В.'
